...
public class HorizontalDottedProgress extends View {
    ...
    private static int  mDotPosition;

    //specify how many dots you need in a progressbar
    private static int mDotAmount = 1;

    public HorizontalDottedProgress(Context context, int mDotAmount) {
        super(context);
    ...
    public static void setNumberOfCheckpoints(int numberOfCheckpoints) {
        mDotAmount = numberOfCheckpoints;
    }

    public static void setCurrentCheckpoint(int currentCheckpoint) {
        mDotPosition = currentCheckpoint;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(Color.parseColor("#5bacdf"));
